...
namespace Test
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Mapa mapaNuevo2 = new Mapa("Mapa 2", "Autor", 1990, "isbn", "312", 20, 30);
            ...
            Escaner e_libro = new Escaner("Marca 1", Escaner.TipoDoc.libro);
            ...
            Console.WriteLine(e_libro + libroNuevo);
            Console.WriteLine("COPIA");
            Console.WriteLine(e_libro + libroCopia);
            Console.WriteLine("NUEVO 2");
            Console.WriteLine(e_libro + libroNuevo2);

            foreach (Documento d in e_libro.ListaDocumentos)
            {
                Console.WriteLine(d);
            }

            Console.WriteLine(libroNuevo.Estado);
            Console.WriteLine(e_libro.CambiarEstadoDocumento(libroNuevo));
            Console.WriteLine(libroNuevo.Estado);
            Console.WriteLine(e_libro.CambiarEstadoDocumento(libroNuevo2));
            Console.WriteLine(e_libro.CambiarEstadoDocumento(libroNuevo2));
            Console.WriteLine(e_libro.CambiarEstadoDocumento(libroNuevo2));
            Console.WriteLine(e_libro.CambiarEstadoDocumento(libroNuevo2));
            Console.WriteLine(e_libro.CambiarEstadoDocumento(libroNuevo2));
            ...
            Console.WriteLine("ESCANER LIBROS");
            Console.WriteLine("DISTRIBUIDOS");
            Informes.MostrarDistribuidos(e_libro, out extension, out cantidad, out resumen);
            Console.WriteLine($"{extension}\n{cantidad}\n{resumen}");

            Console.WriteLine("EN ESCANER");
            Informes.MostrarEnEscaner(e_libro, out extension, out cantidad, out resumen);
            Console.WriteLine($"{extension}\n{cantidad}\n{resumen}");

            Console.WriteLine("EN REVISION");
            Informes.MostrarEnRevision(e_libro, out extension, out cantidad, out resumen);
            Console.WriteLine($"{extension}\n{cantidad}\n{resumen}");

            Console.WriteLine("TERMINADOS");
            Informes.MostrarTerminados(e_libro, out extension, out cantidad, out resumen);
            Console.WriteLine($"{extension}\n{cantidad}\n{resumen}");
